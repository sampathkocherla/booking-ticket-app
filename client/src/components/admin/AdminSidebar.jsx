...
import { LayoutDashboardIcon, ListCollapseIcon, ListIcon, PlusCircleIcon, MenuIcon } from 'lucide-react'
  ...
  return (
    <>
      ...
      <div
        ...
        border-r border-gray-300/30 text-lg max-md:text-md max-md:absolute z-50 
