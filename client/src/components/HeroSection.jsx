    ...
    return (
        <div className='flex flex-col items-start justify-center gap-8 px-10 md:px-14 lg:px-23 bg-[url("./src/assets/backgroundImage.png")] bg-cover bg-center h-screen max-md:overflow-hidden max-md:bg-[url("/mobileback.jpg")] max-md:bg-center max-md:bg-cover'>
            <div className="flex flex-col items-start justify-center max-md:text-sm mt-10 min-2xl:text-xl">
                <img src="./src/assets/marvelLogo.svg" alt="Logo" className='w-60 mx-2 max-md:w-40' />
                <h1 className='text-6xl md: leading-18 max-w-120 font-semibold li mx-2 max-md:text-3xl max-md:leading-10'>Guardians<br></br>Of the Galaxy</h1>
                <div className="flex mx-3 my-2 gap-6 max-sm:flex-col max-sm:gap-2 text-gray-300 max-md:font-semibold">
                    ...
                    <div className="flex items-center">
                        <ClockIcon className='w-4 h-4 mx-1' />2hr 15min
                    </div>
                </div>
                <p className='max-w-md mx-3 max-md:font-semibold min-2xl:max-w-lg text-gray-300 max-md:max-w-sm'>A group of intergalactic criminals must pull together to stop a fanatical warrior with plans to purge the universe</p>
