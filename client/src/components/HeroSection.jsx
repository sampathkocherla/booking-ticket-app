...
const HeroSection = () => {
    ...
    return (
        <div
            className="flex flex-col items-start justify-center gap-8 px-10 md:px-14 lg:px-23 h-screen max-md:overflow-hidden"
            style={{
        ...
        >
            <div className="flex flex-col items-start justify-center max-md:text-sm mt-10 min-2xl:text-xl">
                <img src={marvelLogo} alt="Logo" className="w-60 mx-2 max-md:w-40" />

                <h1 className="text-6xl md:leading-[4.5rem] max-w-120 font-semibold mx-2 max-md:text-3xl max-md:leading-10">
